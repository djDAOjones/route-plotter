...
- [ ] **ROUTE-01 Split hero routes** · Phase 5 route composition
  [[detail]](tickets/ROUTE-01.md) [ready] — Implement simultaneous split
  hero-route branches on one master timeline, with deterministic fork,
  reconvergence and completion semantics.
- [ ] **COMPOSE-01 Route-bound crowd anchors** · Phase 5 composition
  [[detail]](tickets/COMPOSE-01.md) [gated: ROUTE-01 impl] — Bind graph nodes
...
- [ ] **COMPOSE-03 Trace route into guide network** · Phase 5 composition
  [gated: ROUTE-01 impl] — Trace the compatible hero route into a one-way
...
- [ ] **REV-05 Accessibility assurance** · Accessibility assurance
  [gated: ROUTE-01 impl] [verify: NVDA/VoiceOver] — Complete axe,
