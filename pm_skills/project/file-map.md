...
- `tests/areaEdit.test.js` — Screen-space area-handle hit targets and one-commit polygon editing through zoom/pan transforms, and (DEF-17) a polygon drawn in the booted app names its waypoint, so the editor and the outline follow it
