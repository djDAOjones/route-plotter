 ...
 * save and a load. It is not held today — DEF-03, DEF-04 and DEF-31 each break
 * it, and each one loses a user's work — so this file does two things. The
 * property tests state the invariant over the controls where it *does* hold,
 * and the known failures are characterised exactly as they behave now, each
 * with a `todo` naming the W2 fix that will replace it.
 *
